            ...
            <div class="row items-center text-center d-flex">
                <div class="col-sm">
                    <div class="shape shape-primary shape-md mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-github icon"
                ...
                <div class="col-sm">
                    <div class="shape shape-primary shape-md mb-3">
                        <svg class="icon icon-tabler icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="col-sm">
                    ...
                    <p class="text-muted">
                        A modern microservice architecture allows us to deploy only the components you need, without
