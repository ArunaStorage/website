    ...
    <div class="mb-3 mt-5 container">
      <div class="row items-center text-center d-flex">
        <div class="col-sm">
          ...
          <p class="text-muted">
            Public money, public code, host your own instance as you like or
        ...
        <div class="col-sm">
          ...
          <p class="text-muted">
            Strong commitment for fast, safe and reliable code. In the backend
            and the frontend.
          </p>
        </div>
        <div class="col-sm">
          ...
          <p class="text-muted">
            A modern microservice architecture allows us to deploy only the
            components you need, without unnecessary overhead
          </p>
        </div>
      </div>
    </div>
