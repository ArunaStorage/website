            ...
            <div class="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
                <div class="lg:col-span-3">
                    <h1
                        ...
                        <NuxtImg src="aruna_light.png" style="display: inline-block !important; height: 1em"  />
                    </h1>
                    <!-- 
                    <h1
                        class="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-5xl lg:text-6xl dark:text-white">
                        Your distributed scientific data mesh
                    </h1>
                     -->
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Fast, secure, distributed and
                        domain-agnostic
                        data storage with sophisticated metadata management according to FAIR principles. Store and
                        organize
                        your data in new ways, share it with your colleagues and partners. Transparent data management
                        made
                        easy.</p>
                ...
                <div class="lg:col-span-4 mt-10 lg:mt-0">
                    <NuxtImg class="w-full rounded-xl" src="hero_screen_dummy.png" alt="Image Description" />
                </div>
                <!-- End Col -->
            </div>
            <!-- End Grid -->
