<template>
  <div class="max-w-[85rem] border-2 shadow-lg px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-2">
      ...
      <a class="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-slate-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
        ...
        <div class="mt-5">
          <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-800 dark:text-white dark:group-hover:text-gray-400">Free, open-source</h3>
          <p class="mt-1 text-gray-600 dark:text-gray-400">All components are freely available under a permissive open-source license</p>
