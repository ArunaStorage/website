            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    ...
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-300">
                        ...
                        with sophisticated metadata management according to FAIR principles. Store and organize your
                        data in new ways, share it with your colleagues and partners. Transparent data management made
                        easy.
                    </p>
                ...
                <div class="relative ms-4">
                    <NuxtImg class="w-full rounded-md" src="hero_screen_dummy.png" alt="Image Description" />

                    <!-- SVG-->
                    <!-- 
                    <div class="absolute bottom-0 start-0">
                        <svg class="w-2/3 ms-auto h-auto text-arunaPrimary dark:text-slate-900" width="630" height="451"
