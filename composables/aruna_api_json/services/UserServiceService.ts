...
import type { v2GetS3CredentialsUserResponse } from '../models/v2GetS3CredentialsUserResponse';
...
export class UserServiceService {
    ...
    public static userServiceGetDataproxyTokenUser(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/v2/user/{userId}/proxy_token',
            path: {
                'userId': userId,
            },
            query: {
     ...
     * @param userId
     * @param endpointId
     * @returns v2GetS3CredentialsUserResponse A successful response.
     * @returns googlerpcStatus An unexpected error response.
     * @throws ApiError
     */
    public static userServiceGetS3CredentialsUser(
        userId: string,
        endpointId?: string,
    ): CancelablePromise<v2GetS3CredentialsUserResponse | googlerpcStatus> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/v2/user/{userId}/s3_credentials',
            path: {
                'userId': userId,
            },
            query: {
