    ...
    view! {
        <div class="card px-4 my-5 text-start col-10 mx-auto">
            ...
            <div class="card-body">
                ...
                <h3 class="mt-2">"1. Responsible"</h3>

                <div>"Responsible for data processing is:"</div>
                ...
                <div>
                    "The legal basis for the processing of your personal data for the creation of your account is Art. 6 para. 1 lit. b GDPR."
                </div>

                <h3 class="mt-2">"5. Storage period of the data"</h3>

                <div>
                    "Your personal data will be stored for the duration of your account with us. If you delete your account, your data will be deleted immediately."
                </div>

                <h3 class="mt-2">"6. Your rights as a data subject"</h3>

                <div>
                    "You have the right to request information about the personal data stored by us as well as the right to correction, deletion and restriction of the processing of your personal data (Art. 15, 16 and 18 of the European General Data Protection Regulation). If you believe that the processing of data is unlawful, you can lodge a complaint with the Hessian Data Protection Officer (Art. 77 of the European General Data Protection Regulation, §55 of the Hessian Data Protection and Freedom of Information Act). Furthermore, you are entitled to revoke your consent to the processing of data and to request the deletion of your data, while the processing of data until then remains lawful (Art. 7 para. 3 and Art. 17. EU-GDPR). You can also request the transmission of your data in portable form or have it transferred to another controller (Art. 20 EU-GDPR)."
                </div>

                <h3 class="mt-2">"7. Contact"</h3>
                ...
                <div>
                    ...
                    </div> <div>"Justus-Liebig-Universität Gießen"</div>
                    <div>"Der behördliche Datenschutzbeauftragte"</div>
                    <div>"Ludwigstraße 23"</div> <div>"35390 Gießen"</div>
                    <div>"Tel: 0641-99 122 30 / 0641-99 122 70"</div>
                    <a href="mailto:Datenschutz@uni-giessen.de">"datenschutz@uni-giessen.de"</a>
                    <div>"Stand: 20. April 2023"</div> <div></div>
                    <div class="mt-2">
                        "Please note that this privacy policy may be changed at any time. You can find the current version on this website."
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card px-4 my-5 text-start col-10 mx-auto mt-3">
            <div class="card-body">
                ...
                <div>
                    "Die Rechtsgrundlage für die Verarbeitung Ihrer personenbezogenen Daten zur Erstellung Ihres Accounts ist Art. 6 Abs. 1 lit. b DSGVO."
                </div>

                <h3 class="mt-2">"5. Speicherdauer der Daten"</h3>

                <div>
                    "Ihre personenbezogenen Daten werden für die Dauer Ihres Accounts bei uns gespeichert. Wenn Sie Ihren Account löschen, werden Ihre Daten umgehend gelöscht."
                </div>

                <h3 class="mt-2">"6. Ihre Rechte als betroffene Person"</h3>
                ...
                <div>
                    ...
                    <a href="mailto:Datenschutz@uni-giessen.de">"datenschutz@uni-giessen.de"</a>
                    <div class="mt-2">
                        "Bitte beachten Sie, dass diese Datenschutzerklärung jederzeit geändert werden kann. Eine jeweils aktuelle Version finden Sie auf unserer Website."
                    </div>
                </div>
            </div>
        </div>
