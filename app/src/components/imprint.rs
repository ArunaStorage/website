...
pub fn Imprint() -> impl IntoView {
    ...
    view! {
            <div class="card px-4 my-5 text-start col-10 mx-auto">
                ...
                <div>"We collect personal data from you when you register for an account on our website. The following personal data is collected:"</div>
                ...
                <div>"The personal data provided by you is exclusively used for the creation of your account. If an email address is provided, we will inform you about account-related events."</div>

                <h3 class="mt-2">"4. Legal basis for data processing"</h3>

                <div>"The legal basis for the processing of your personal data for the creation of your account is Art. 6 para. 1 lit. b GDPR."</div>

                <h3 class="mt-2">"5. Storage period of the data"</h3>

                <div>"Your personal data will be stored for the duration of your account with us. If you delete your account, your data will be deleted immediately."</div>

                <h3 class="mt-2">"6. Your rights as a data subject"</h3>

                <div>"You have the right to request information about the personal data stored by us as well as the right to correction, deletion and restriction of the processing of your personal data (Art. 15, 16 and 18 of the European General Data Protection Regulation). If you believe that the processing of data is unlawful, you can lodge a complaint with the Hessian Data Protection Officer (Art. 77 of the European General Data Protection Regulation, §55 of the Hessian Data Protection and Freedom of Information Act). Furthermore, you are entitled to revoke your consent to the processing of data and to request the deletion of your data, while the processing of data until then remains lawful (Art. 7 para. 3 and Art. 17. EU-GDPR). You can also request the transmission of your data in portable form or have it transferred to another controller (Art. 20 EU-GDPR)."</div>

                <h3 class="mt-2">"7. Contact"</h3>

                <div>"If you have any questions about the collection, processing or use of your personal data, please contact us by email at "<a href="mailto:datenschutz@aruna-storage.org">"datenschutz@aruna-storage.org"</a>"."
