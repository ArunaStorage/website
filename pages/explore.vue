...
<template>
  ...
  <div class="flex sm:flex-col md:flex-row items-center md:container w-full mx-auto mt-10">
    <div class="md:basis-1/4">
      <h2 class="text-2xl font-bold text-aruna-800 dark:text-white">Search results</h2>
      <div class="mt-2 text-slate-700 ">About {{ estimatedTotal }} results</div>
    </div>
  ...
  <div class="flex sm:flex-col md:flex-row md:container w-full mx-auto my-5 border-t pt-4">
    <div class="md:basis-1/4 sm:w-[90vw] sm:mx-auto border-r px-2">
      <h3 class="text-xl font-bold text-slate-500 dark:text-white">
        Filters
      </h3>

      <div class="grid space-y-1 mt-4 items-center">
        <p class="text-sm uppercase text-slate-500 dark:text-white">Resource Type</p>
      ...
      <!-- Start Custom Filter -->
      <p class="mt-6 mb-2 text-sm uppercase text-slate-500 dark:text-white">Custom Filter</p>
      <input v-model="customFilter"
             @keyup.enter="queryResources"
             type="text"
      ...
      <div class="my-6 bg-white border border-l-4 border-l-aruna-700 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:border-t-blue-500 dark:shadow-slate-700/[.7]">
        <div class="p-4 md:p-5">
          <h3 class="font-bold text-aruna-800 dark:text-white">
            Filter arguments by value.
          </h3>
          <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
            E.g: <strong>size > 1024</strong> or <strong>labels.key = akey</strong>
          </p>
          <div class="mt-2 text-sm text-gray-500 dark:text-gray-400">
            The currently available parameters to create custom filters can be looked up in the
            <NuxtLink class="text-aruna-800 dark:text-aruna-600"
                      rel="noreferrer"
                      target="_blank"
