...
async function queryResources() {
  ...
  try {
    const response = await $fetch<v2SearchResourcesResponse>(
      "https://api.dev.aruna-storage.org/v2/search",
      {
...
<template>
  ...
  <div
    class="flex sm:flex-col md:flex-row items-center md:container w-full mx-auto mt-10"
  >
    ...
    <div class="md:basis-3/4 sm:mt-3 md:mt-0">
      <div>
        <label class="sr-only" for="hs-trailing-button-add-on-with-icon"
          >Label</label
        >
  ...
  <div
    class="flex sm:flex-col md:flex-row md:container w-full mx-auto my-5 border-t pt-4"
  >
    <div class="md:basis-1/4 sm:w-[90vw] sm:mx-auto border-r px-2">
      ...
      <div class="grid space-y-1 mt-4 items-center">
        ...
        >
          ...
          />
          <IconWorldSearch
            class="flex-shrink-0 size-5 mx-2 text-gray-500 ms-5 dark:text-gray-400"
          />
      ...
      >
        <div class="p-4 md:p-5">
          ...
          <div class="mt-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            looked up in the
            <NuxtLink
              class="text-aruna-800 dark:text-aruna-600"
              rel="noreferrer"
              target="_blank"
